    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.image_tts_set:
                Intent intent = new Intent(MainActivity1.this, TtsSettings.class);
...
//			int code = mTts.synthesizeToUri(text, path, mTtsListener);
    ...
    private SynthesizerListener mTtsListener = new SynthesizerListener() {
        ...
        public void onSpeakBegin() {
            //showTip("开始播放");
            Log.d(MainActivity1.TAG, "开始播放：" + System.currentTimeMillis());
        }
    ...
    private void showTip(final String str) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mToast = Toast.makeText(MainActivity1.this.getApplicationContext(), str, Toast.LENGTH_SHORT);
                mToast.show();
            }
        });
    }
    ...
    private String getResourcePath() {
        ...
        //发音人资源
        if (mEngineType.equals(SpeechConstant.TYPE_XTTS)) {
            tempBuffer.append(ResourceUtil.generateResourcePath(this, RESOURCE_TYPE.assets, type + "/" + MainActivity1.voicerXtts + ".jet"));
        } else {
            tempBuffer.append(ResourceUtil.generateResourcePath(this, RESOURCE_TYPE.assets, type + "/" + MainActivity1.voicerLocal + ".jet"));
        }
