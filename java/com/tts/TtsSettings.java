...
import com.tts.SettingTextWatcher;
...
public class TtsSettings extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSpeedPreference.getEditText().addTextChangedListener(new com.tts.SettingTextWatcher(com.tts.TtsSettings.this, mSpeedPreference, 0, 200));

        mPitchPreference = (EditTextPreference) findPreference("pitch_preference");
        mPitchPreference.getEditText().addTextChangedListener(new com.tts.SettingTextWatcher(com.tts.TtsSettings.this, mPitchPreference, 0, 100));

        mVolumePreference = (EditTextPreference) findPreference("volume_preference");
        mVolumePreference.getEditText().addTextChangedListener(new com.tts.SettingTextWatcher(com.tts.TtsSettings.this, mVolumePreference, 0, 100));
