...
public class NativeCaller {
	...
	/**
	 * 请求视频数据，传⼊ uid、streamid、substreamid
	 */
	...
	/**
	 * 设置设备⽤户参数，包括访客、操作者、管理员参数，set_users.cgi
	 */
